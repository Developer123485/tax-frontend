...
import { RemittersService } from "../services/remitters.service";
...
export default function Remitters() {
    ...
    const columns = [
        ...
        {
            name: "Email",
            selector: (row) => row?.remitterEmail || "",
        },
        {
            name: "Actions",
            selector: (row) => (
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        <span>
                            ...
                            <a
                                onClick={(e) => {
                                    e.preventDefault();
                                    router.push(`/remitters/remitter-detail?id=${row.id}`);
                                }}
                            >
                                <OverlayTrigger
                                    placement="bottom"
    ...
    useEffect(() => {
        fetchRemitters(currentPage);
    }, [currentPage]);

    useEffect(() => {
        const delayDebounce = setTimeout(() => {
            if (search)
                fetchRemitters(1, search);
        }, 2000);
    ...
    function deleteRemitter(e) {
        ...
        RemittersService.deleteRemitter(deleteId)
            .then((res) => {
                if (res) {
                    toast.success("Delete Remitter Successfully");
                    fetchRemitters(currentPage);
    ...
    function fetchRemitters(currentPage, searchValue) {
        setShowLoader(true);
        setRemitters([]);
        const model = {
            pageSize: pageSize,
        ...
        RemittersService.getRemitters(model)
            .then((res) => {
                if (res && res.remitterList && res.remitterList.length > 0) {
                    setRemitters(res.remitterList);
                    ...
                    <div className="row align-items-center deductors-sec">
                        ...
                        <div className="col-md-8">
                            <div className="row justify-content-between">
                                <div
                                    className="col-md-4"
                                    onClick={(e) => router.push("/remitters/remitter-detail")}
                                >
                ...
                <div className="container">
                    <div className="bg-white pb-2 pb-md-0 border border-1 rounded-3">
                        <div className="row px-3 py-3 px-md-3 py-md-2 align-items-center datatable-header">
                            <div className="col-md-8">
                                <h4 className="fw-bold mb-0">Remitters</h4>
                            </div>
                            <div className="col-md-4">
                                    ...
                                    <div className="input-group searchbox">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (!e.target.value) {
                                                    setTimeout(() => {
                                                        fetchRemitters(1, e.target.value)
                                                    }, 600);
                                                }
                                            }}
                                        />
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="table-responsive">
                                    <div>
                                        {!showLoader && remitters && remitters.length > 0 && (
                                            <DataTable
                                                fixedHeader
