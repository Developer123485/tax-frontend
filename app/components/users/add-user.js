...
export default function AddUser(props) {
  ...
  function validate() {
    ...
    if (!userDetails.password && userDetails.id <= 0) {
    ...
    <>
      ...
      <section className="">
        <div className="container-fluid bg-light-blue">
          <div className="row">
            <div className="col-md-12 d-flex align-items-center form-sec">
              <div>
