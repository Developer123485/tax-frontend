...
import DeductorDetail from "@/app/components/deductors/deductor-detail/page";
import ResponsibleDetail from "@/app/components/deductors/responsible-detail/page";
...
export default function Detail({ params }) {
    ...
    const correctionId = resolvedParams?.correctionId;
    ...
    function getCorrectionStatement() {
        if (deductorId) {
            CorrectionsService.getCorrectionStatement(deductorId, correctionId).then(
                (res) => {
                    if (res && res.id > 0) {
